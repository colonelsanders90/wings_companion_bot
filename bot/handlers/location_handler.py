...
async def handle_location(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Delete the "Share My Location" keyboard prompt message
    ...
    # Summary — ReplyKeyboardRemove dismisses the keyboard in case it's still open
    ...
    # Plain text message — can be edited into the main menu on Back to Start
